import os
os.environ.get("NEO4J_PASSWORD","")"Layer 3: 智能分析 - 风险传导模拟 + 全景报告os.environ.get("NEO4J_PASSWORD","")"
...
# LLM 深度分析
prompt = fos.environ.get("NEO4J_PASSWORD","")"你是新能源汽车供应链分析师。基于以下数据生成深度分析报告：
...
请用中文回复，结构化输出。os.environ.get("NEO4J_PASSWORD","")"
